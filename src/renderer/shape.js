...
export function ring(context, attributes) {
  ...
  const defautlStrokeWidth = 1;

  // 内圆
  const innerCircle = circle(context, {
    fill: 'transparent',
    stroke: stroke || fill,
    strokeWidth,
    cx,
  ...
  // 外圆
  const outerCircle = circle(context, {
    fill: 'transparent',
    stroke: stroke || fill,
    strokeWidth,
    cx,
  ...
  const ring = circle(context, {
    ...styles,
    strokeWidth: r2 - r1 - (strokeWidth || defautlStrokeWidth),
    stroke: fill,
    fill: 'transparent',
    cx,
    cy,
  ...
  return [innerCircle, ring, outerCircle];
}
